...
data class BusStop(
    ...
    @field:Element(name = "arrTime", required = false) var arrTime: String? = null,
    @field:Element(name = "arrPrevStationCnt", required = false) var arrPrevStationCnt: String? = null
)
